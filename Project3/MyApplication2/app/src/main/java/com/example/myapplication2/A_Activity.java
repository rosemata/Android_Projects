...
public class A_Activity extends AppCompatActivity {
    ...
    private final A_Fragment2 mQuoteFragment = new A_Fragment2();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleArray = getResources().getStringArray(R.array.Attraction_Titles);
        mWebsiteArray = getResources().getStringArray(R.array.Attraction_Description);
        ...
        mModel.getSelectedItem().observe(this, item -> {
            if (!mQuoteFragment.isAdded()) {
                ...
                fragmentTransaction3.add(R.id.quote_fragment_container,
                        mQuoteFragment);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()) {
            case R.id.attractions_option:
                ...
                Toast.makeText(this, "Attractions Selected", Toast.LENGTH_SHORT);
